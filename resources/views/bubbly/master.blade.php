...
<html>
  <head>
    ...
    <link rel="stylesheet" href="bubly/fonts/font-awesome/css/font-awesome.min.css">
    <!-- theme stylesheet-->
  ...
  <body>
    <!-- navbar-->
    <header class="header">
      <nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow"><a href="#" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="fa fa-align-left"></i></a><a href="index.html" class="navbar-brand font-weight-bold text-uppercase text-base">Bubbly Dashboard</a>
        <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
          ...
          <li class="nav-item dropdown ml-auto"><a id="userInfo" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><img src="bubly/img/avatar-6.jpg" alt="Jason Doe" style="max-width: 2.5rem;" class="img-fluid rounded-circle shadow"></a>
    ...
    <div class="d-flex align-items-stretch">
      <div id="sidebar" class="sidebar py-3">
        ...
        <ul class="sidebar-menu list-unstyled">
              ...
              <li class="sidebar-list-item"><a href="{{ url('index') }}" class="sidebar-link text-muted @if (Request::is('index')) active @endif"><i class="o-sales-up-1 mr-3 text-gray"></i><span>Orders</span></a></li>
    ...
    <script src="bubly/js/charts-home.js"></script>
